    ...
    <form action="" method="post">
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <input type="number" min="1900" max="2099" step="1" value="<?= $stt['tahun_mulai'] ?>" class="form-control" name="tahun_mulai">
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <select name="status" id="status" class="form-control">
                    <option value="<?= $status['status_karyawan'] ?>"><?= $stt['status_karyawan'] ?></option>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <input type="number" name="bpjs_ket" id="bpjsket" class="form-control" value="<?= $stt['bpjs_ket'] ?>">
                <?= form_error('bpjs_ket', ' <small class="text-danger pl-3">', '</small>'); ?>
            </div>
            <div class="col-lg-4">
                <label for="">No Rekening</label>
                <input type="number" name="no_rek" id="norek" class="form-control" value="<?= $stt['no_rek'] ?>">
        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <input type="number" name="gaji" id="gaji" class="form-control" value="<?= $stt['gaji_pokok'] ?>">
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <textarea name="pekerjaan" id="pekerjaan" cols="10" rows="5" class="form-control"><?= $stt['pekerjaan'] ?></textarea>
                <?= form_error('gaji', ' <small class="text-danger pl-3">', '</small>'); ?>
            </div>
        </div>
