<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <input type="text" name="lembaga" id="lembaga" class="form-control" value="">
            <?= form_error('lembaga', ' <small class="text-danger pl-3">', '</small>'); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-2">
            <label for="">Tahun Masuk</label>
            <input type="number" name="masuk" id="masuk" class="form-control" value="">
            <?= form_error('masuk', ' <small class="text-danger pl-3">', '</small>'); ?>
        </div>
        <div class="col-lg-2">
            <label for="">Tahun Selesai</label>
            <input type="number" name="selesai" id="selesai" class="form-control" value="">
    ...
    <div class="row mt-3">
        <div class="col-lg-4">
            ...
            <img src="<?= base_url('assets/img/ijazah/awal.png') ?>" class="img-thumbnail" alt="gambar" id="gmbr"><br>
