                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $b['id_bidang'] ?></td>
                            <td><?= $b['bidang'] ?></td>
                            <td class="text-center"><a href="<?= base_url('master/delbidang/') . $b['id_bidang']  ?>" class="btn btn-danger">Hapus</a></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Bidang</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('master/inpbidang') ?>" method="post">
                    <div class="row">
                        <div class="col-lg-12">
